...
## Why Magnetic Anomoly Map are needed
...
## Need Non GPS Navigation

Magnetic maps are needed for navigation in non GPS environments.
...
<br> These same concerns are amplified in the air industry where planes have the additional worry of being tricked into flying into dangerous no fly zones.
:::
...
![](img/solarexp.jpg) (@sunEarthField)
...
![](img/editted_usa_only.jpg){width="90%"} @usamagmap
...
:::{.columns}
::::{.column width=60%}
Maps are made using special equipted planes.
...
* Data needs to be cleaned to remove the plane's magnetic field.
...
![](img/DALL-Eplanemagneticfieldlines-geomancy.png)@dall-e
...
![alt](img/DALL-E-weatherballoonsensorpayload.png)@dall-e

## How Far can they go

These balloons can circumnavigate the world several times 

![](img/picoBallon_world_circum.png)@picoballon
...
::::
::::{.column width=80%}
![](img/STEM_MagMeasurement-2023%20(1).png) 
::::
:::
